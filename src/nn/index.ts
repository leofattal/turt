...
export { RMSNorm } from "./rmsnorm.js";
export { mseLoss } from "./losses.js";

// Planned layers (see PRD "Neural Networks"): CNN, RNN/LSTM/GRU, transformer
// encoder/decoder, MoE. Each should extend Module and compose primitive Tensor
// ops so autodiff applies without hand-written backward passes.
